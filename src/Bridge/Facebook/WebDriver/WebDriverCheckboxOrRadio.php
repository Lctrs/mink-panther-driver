 ...
 */
abstract class WebDriverCheckboxOrRadio implements WebDriverSelectInterface
{
     ...
     */
    protected function byValue(string $value, bool $select = true) : void
    {
        $matched = false;
     ...
     * @throws NoSuchElementException
     */
    protected function byIndex(int $index, bool $select = true) : void
    {
     ...
     */
    protected function byVisibleText(string $text, bool $partial = false, bool $select = true) : void
    {
        foreach ($this->getRelatedElements() as $element) {
     ...
     */
    protected function getRelatedElements(?string $value = null) : array
    {
