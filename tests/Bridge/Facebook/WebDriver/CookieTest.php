...
namespace Lctrs\MinkPantherDriver\Tests\Bridge\Facebook\WebDriver;
...
final class CookieTest extends TestCase
{
     ...
     */
    public function testShouldContainNoNullValues() : void
    {
        $cookie = new Cookie('cookieName', 'someValue');
     ...
     */
    public function testShouldValidateCookieOnConstruction(?string $name, ?string $value, ?string $domain, ?string $expectedMessage) : void
    {
        if ($expectedMessage) {
     ...
     * @return mixed[]
     */
    public function invalidCookieProvider() : array
    {
        return [
